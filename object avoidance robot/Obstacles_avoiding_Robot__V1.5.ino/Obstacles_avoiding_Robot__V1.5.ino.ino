...
//******************************CALIBRATION Value********************************************//
#define Val  200             //distance highest range of sensor
#define Dis   30          //minimum distance
#define Dis1  35          //minimum distance
#define MinPWM 25

#define turningspeed 80    //Turning speed of bot ---must be less and efficient
#define interval 600     // Time tiill robot moves backward without obstruction
#define pwmspeed 100      // Max forward Speed
#define U_turntime 1600  //Time take by bot to complete u turn at u turning Speed
